...
---
name: sycophancy-preventing
description: Rules for avoiding sycophancy in brainstorming, planning, diagnostic and review. Use when you want to push for specificity, evidence, and actionable next steps.
tools:
  - ask_user
  - request_user_input
  - ask_user_question
